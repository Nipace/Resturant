...
using TMDoyle.Repository.Implementation;
using TMDoyle.Repository.Interface;
//using TMDoyle.Service.Interfaces;
using TMDoyle.Service.RequestFormatters;
using TMDoyle.Service.ResponseFormatters;

namespace TMDoyle.Service.Implementation
{
    #region Interface
